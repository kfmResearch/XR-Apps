...
$$A_{s,H} = 2 \pi r^2 = 2\cdot\pi\cdot(8 \text{mm})^2 = 402 \text{mm}^2$$
====
11
...
Mit dem Winkel der Druckfeldneigung $\alpha = 45 \degree $ und $z_v = 0.8 \text{m}  $ ergibt sich die erforderliche Bügelbewehrung zu: 

$$ a_{sw,erf} = \frac{V_d}{z_v \cdot cot \alpha \cdot f_{sd}} = 1´293 \text{mm}^2/\text{m} $$

Diese wird abgedeckt mit einer gewählten Bewehrung von Ø12@150 zweischnittig mit 

$$ a_{s} = 2 \cdot\pi\cdot(6 \text{mm})^2 / 150 \text{mm} = 1´506 \text{mm}^2/\text{m} $$
====
19

Die notwendinge verteilte Längsbewehrung aus der Querkraftbemessung der Platte resultiert zu

$$ a_{s,erf} = \frac{V_d}{z_v \cdot tan \alpha \cdot f_{sd}} = 1´293 \text{mm}^2/\text{m} $$
