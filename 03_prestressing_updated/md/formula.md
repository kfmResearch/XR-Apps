...
Die verwendeten Spanngliedeinheiten sind die VSL 6-19 mit je 19 Litzen à 0.6“ der Festigkeitsklasse Y1860. Diese werden auf eine initiale Vorspannung von $0.75 \cdot f_{pk}$ vorgespannt. 
...
$\zeta _1 = \frac{h}{2} = 600 \text{mm}, \zeta _2 = \frac{t}{2} + \frac{6}{95} \cdot \frac{b_{\text{eff},i}}{2} = 208.4 \text{mm}$\
